...
import TerminUpdateComponent from '@/entities/termin/termin-update.vue';
import TerminClass from '@/entities/termin/termin-update.component';
...
describe('Component Tests', () => {
  describe('Termin Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<TerminClass>(TerminUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        // THEN
        expect(mockedAxios.put).toHaveBeenCalledWith('api/termins', entity);
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        // THEN
        expect(mockedAxios.post).toHaveBeenCalledWith('api/termins', entity);
        expect(comp.isSaving).toEqual(false);
      });
    });
  });
