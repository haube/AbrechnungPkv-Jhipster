...
import RechnungUpdateComponent from '@/entities/rechnung/rechnung-update.vue';
import RechnungClass from '@/entities/rechnung/rechnung-update.component';
...
describe('Component Tests', () => {
  describe('Rechnung Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<RechnungClass>(RechnungUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        // THEN
        expect(mockedAxios.put).toHaveBeenCalledWith('api/rechnungs', entity);
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        // THEN
        expect(mockedAxios.post).toHaveBeenCalledWith('api/rechnungs', entity);
        expect(comp.isSaving).toEqual(false);
      });
    });
  });
