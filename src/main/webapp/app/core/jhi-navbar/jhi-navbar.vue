    ...
    <b-navbar toggleable="md" type="dark" class="jh-navbar">
        <div class="jh-logo-container float-left">
            ...
            <b-navbar-brand class="logo float-left" b-link to="/">
                ...
                <span v-text="$t('global.title')" class="navbar-title">pkv</span> <span class="navbar-version">{{version}}</span>
            </b-navbar-brand>
        </div>
        <b-collapse is-nav id="header-tabs">
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/entity/arzt">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.arzt')">Arzt</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/termin">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.termin')">Termin</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/rechnung">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.rechnung')">Rechnung</span>
                    </b-dropdown-item>
