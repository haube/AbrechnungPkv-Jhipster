        ...
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                ...
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-bind:value="$t('pkvApp.rechnung.arzt.name')" for="rechnung-arzt">Arzt</label>
                        <select class="form-control" id="rechnung-arzt" name="arzt" v-model="rechnung.arzt" >
                            <option v-bind:value="null"></option>
                            <option v-bind:value="rechnung.arzt && arztOption.id === rechnung.arzt.id ? rechnung.arzt : arztOption" v-for="arztOption in arzts" :key="arztOption.id">{{arztOption.name}}</option>
                        </select>
                    </div>
                </div>
                <div>
